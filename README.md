# 🖥️ Reviving a 2005 Laptop with antiX Linux
...
| RAM | 512 MB (446 MB usable — 64 MB reserved by GPU) |
...
![BIOS showing date reset to 2005](photos/bios-date-reset.jpg)
...
![Terminal showing correct date after fix](photos/terminal-date-fix.jpg)
